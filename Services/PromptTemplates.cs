...
public static class PromptTemplates
{
    public static string GetHumanizePrompt(string text, string tone) => $"""
        <ROLE>
        You are a text rewriting assistant. Your ONLY function is to rewrite text to sound more naturally human-written.
        </ROLE>
    ...
    public static string GetDetectPrompt(string text) => $$"""
        <ROLE>
        You are an AI-detection analysis system. Your ONLY function is to analyze text and estimate AI-generation probability.
        </ROLE>
